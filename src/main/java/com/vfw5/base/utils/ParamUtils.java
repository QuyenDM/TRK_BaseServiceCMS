...
public class ParamUtils {
    ...
    public final static String ORDER_ACTION_EXPORT = "120";
    public final static String NUMBER_DAY_ORDER_EXPIRED = "NUMBER_DAY_ORDER_EXPIRED";
    ...
    // Add by QuyenDM 06/06/2015-----------------------SalePolicyPriceType-----------------
    public static final String SINGLE_PRICING = "1";
    public static final String SCOPE_PRICING = "2";
    ...
    public static final String ORDER_STATUS_SENT_VTP = "2";
    public static final String ORDER_STATUS_SENT_BPDV = "3";
    public static final String ORDER_STATUS_CREATED = "4";
    public static final String ORDER_STATUS_REJECTED = "5";
    public static final String ORDER_STATUS_TRANSED = "6";
    public static final String ORDER_IS_PROCESSING = "ORDER_IS_PROCESSING";
    public static final String UPDATED = "UPDATED";
    //
    public static final String ORDER_ACTION_IS_PROCESSING = "ORDER_ACTION_IS_PROCESSING";
    public static final String ORDER_ACTION_CREATE = "ORDER_ACTION_CREATE";
    
    public static final String ORDER_ACTION_STATUS_CANCELED = "0";//da bi huy
    public static final String ORDER_ACTION_STATUS_CANCELED_STR = "CANCELED";//da bi huy
    ...
    public static final class ERROR_MESSAGE {
        ...
        public static final String ORDER_IEXPORTED = "ORDER_IEXPORTED"; // yeu cau da o trang thai nhap xuat
        public static final String CREATE_COMMAND_FAIL = "CREATE_COMMAND_FAIL"; // tao lenh that bai
        public static final String UPDATE_ORDER_ACTION_FAIL = "UPDATE_ORDER_ACTION_FAIL"; // tao lenh that bai
        public static final String UPDATE_ORDER_FAIL = "UPDATE_ORDER_FAIL"; // 
        public static final String FAIL = "0";
    }
